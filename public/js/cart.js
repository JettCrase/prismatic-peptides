function clearPrismaticCart(event) {
...
function cartSummaryHTML(subtotal) {
  ...
  const estimatedTotal = feeBase;
  return `
    <div class="cart-summary-trust"><span>Secure checkout</span><span>RUO certification required</span><span>Prismatic Peptides</span></div>
