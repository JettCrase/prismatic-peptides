module.exports = {
  ...
  // Percentage-based processing fee added to every order.
  ORDER_FEE_RATE: Number(process.env.ORDER_FEE_RATE || 0),
  ...
  CRYPTO_WALLETS: {
    BTC: process.env.CRYPTO_BTC_ADDRESS || 'bc1qdrajxt9fl2zutylt36w7u7cuunmd7946afx4ar',
  ...
  BTC_MONITOR: {
    ...
    ADDRESSES: String(process.env.BTC_MONITOR_ADDRESSES || process.env.CRYPTO_BTC_ADDRESS || 'bc1qdrajxt9fl2zutylt36w7u7cuunmd7946afx4ar')
  ...
  ORDER_BACKUP_EMAIL_FROM: process.env.ORDER_BACKUP_EMAIL_FROM || process.env.SMTP_USER || 'orders@prismaticpeptides.com',
  ...
  SITE_NAME: process.env.SITE_NAME || 'Prismatic Peptides',
};
